...
class StickMan(Sprite):
    ...
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [
            tk.PhotoImage(file=spr + 'stickman-L1'),
            tk.PhotoImage(file=spr + 'stickman-L2'),
            tk.PhotoImage(file=spr + 'stickman-L3')
        ]
        self.images_right = [
            tk.PhotoImage(file=spr + 'stickman-R1'),
            tk.PhotoImage(file=spr + 'stickman-R2'),
            tk.PhotoImage(file=spr + 'stickman-R3')
        ]
